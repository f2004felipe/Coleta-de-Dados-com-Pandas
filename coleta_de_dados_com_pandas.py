# -*- coding: utf-8 -*-
"""Coleta de Dados com Pandas

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1IqCnQWnDlb7-Uja0Px9gxk_A8mXVFOoV
"""
...
respostaInvestir = df.iloc[:,2]
respostaJuros = df.iloc[:,3]
respostaInvestimento = df.iloc[:,4]
...
contagemJuros = respostaJuros.value_counts()
...
# Grafico de Juros
categoriaJuros = contagemJuros.index
valorJuros = contagemJuros.values

plt.pie(valorJuros, labels=categoriaJuros, autopct='%1.1f%%', startangle=140)
